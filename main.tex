...
\logo{./resources/images/LogoFeverTokens.png}{./resources/images/LogoENSATe.png}
\institute{ENSA TETOUAN}
\faculty{Université Abdelmalek Essaadi}
\department{GENIE INFORMATIQUE}
\title{Mémoire de Fin d'Année}
\subtitle{Étude et développement d'une application Web 3.0 avec Backend Hybride Cloud/Blockchain}
\author{\textit{Author : }\\M. Zakaria \textsc{AIT ALI}}
\supervisor{\textit{ENCADRE PAR :}\\Dr. Mohamed \textsc{TOUB}}{Dr. Ahmed \textsc{BENTAJER}} 
\context{Année universitaire : 2022-2023}
